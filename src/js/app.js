...
/*
Библиотека параллакса Rellax.js
*/
...
Документация по работе в шаблоне: В HTML добавляем к блоку атрибут data-aos
* - AOS.js
Документация библиотеки: https://github.com/michalsnik/aos
Примеры по работе с библиотекой: https://michalsnik.github.io/aos/

* - wow.js (необходимо подключить animate.css)
Документация библиотеки: https://wowjs.uk/docs.html
